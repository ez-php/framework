...
final class RouterServiceProvider extends ServiceProvider
{
    ...
    {
        /** @var list<array{method: string, path: string, name: string|null, handler: array{0: class-string, 1: string}, middleware: array<int, non-empty-string>, constraints: array<string, string>, csrfExempt: bool}> $data */
